...
package com.nercms.schedule.sip.stack.jstun.core.header;
...
import com.nercms.schedule.sip.stack.jstun.core.util.Utility;
...
public class MessageHeader implements MessageHeaderInterface {
     ...
     * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
	 */
	private static Logger logger = Logger.getLogger("com.nercms.schedule.sip.stack.jstun.core.header.MessageHeader");
