...
package com.nercms.schedule.sip.stack.jstun.core.attribute;
...
public abstract class MessageAttribute implements MessageAttributeInterface {
	private static Logger logger = Logger.getLogger("com.nercms.schedule.sip.stack.jstun.core.util.MessageAttribute");
