...
import com.nercms.schedule.sip.stack.tools.Timer;
...
public class SipStack extends Configure {
	...
	// *********************** software release ***********************
	/** Release */
	public static final String release = "schedule sip ua";//"mjsip stack 1.6";
	/** Authors */
	 ...
	 * unaware SIP UAs.
	 */
	public static int default_port = GD.SIP_SERVER_PORT;
	 ...
	 */
	//默认注册超时时间为360秒
	public static int default_expires = 360;
