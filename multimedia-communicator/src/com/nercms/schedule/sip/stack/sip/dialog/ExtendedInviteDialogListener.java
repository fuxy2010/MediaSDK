...
package com.nercms.schedule.sip.stack.sip.dialog;
...
public interface ExtendedInviteDialogListener extends
		com.nercms.schedule.sip.stack.sip.dialog.InviteDialogListener {

	/** When an incoming REFER request is received within the dialog */
	public void onDlgRefer(com.nercms.schedule.sip.stack.sip.dialog.InviteDialog dialog,
	...
	public void onDlgReferResponse(com.nercms.schedule.sip.stack.sip.dialog.InviteDialog dialog,
			int code, String reason, Message msg);

	/** When an incoming NOTIFY request is received within the dialog */
	public void onDlgNotify(com.nercms.schedule.sip.stack.sip.dialog.InviteDialog dialog,
			String event, String sipfragment, Message msg);

	/** When a response is received for a NOTIFY request within the dialog */
	// public void onDlgNotifyResponse(com.nercms.schedule.sip.stack.sip.dialog.InviteDialog dialog,
	// int code, String reason, Message msg);
	/**
	 * When an incoming request is received within the dialog different from
	 * INVITE, CANCEL, ACK, BYE, REFER, NOTIFY
	 */
	public void onDlgAltRequest(com.nercms.schedule.sip.stack.sip.dialog.InviteDialog dialog,
	 ...
	 */
	public void onDlgAltResponse(com.nercms.schedule.sip.stack.sip.dialog.InviteDialog dialog,
	 ...
	 */
	// public void onDlgAltTimeout(com.nercms.schedule.sip.stack.sip.dialog.InviteDialog dialog,
	// String method);
}
