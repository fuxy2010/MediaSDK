...
import com.nercms.schedule.sip.stack.sip.dialog.*;
...
import com.nercms.schedule.sip.stack.sip.header.MultipleHeader;
import com.nercms.schedule.sip.stack.tools.Log;
import com.nercms.schedule.sip.stack.tools.LogLevel;

/* HSC CHANGES START */
// import com.nercms.schedule.sip.stack.sdp.*;
...
public class Call implements InviteDialogListener {
	...
	public void call(String callee, String sdp, String icsi) {		// modified by mandrajg
		//android.util.Log.v("UA", "call sdp: " + sdp);
	...
	public void onDlgBye(InviteDialog d, Message msg){
		//android.util.Log.v("UA", "onDlgBye");
		if (d != dialog) {
			printLog("NOT the current dialog", LogLevel.HIGH);
			return;
		}
	...
	public void onDlgByeFailureResponse(InviteDialog d, int code,
			String reason, Message msg) {
		//android.util.Log.v("UA", "onDlgByeFailureResponse");
		if (d != dialog) {
			printLog("NOT the current dialog", LogLevel.HIGH);
			return;
		}
