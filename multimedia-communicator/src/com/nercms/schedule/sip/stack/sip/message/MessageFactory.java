...
package com.nercms.schedule.sip.stack.sip.message;

import com.nercms.schedule.sip.engine.sipua.SipdroidEngine;
import com.nercms.schedule.sip.stack.sip.address.*;
import com.nercms.schedule.sip.stack.sip.header.SubjectHeader;
import com.nercms.schedule.sip.stack.sip.header.ReferToHeader;
import com.nercms.schedule.sip.stack.sip.header.ReferredByHeader;
import com.nercms.schedule.sip.stack.sip.header.EventHeader;
 ...
 */
public class MessageFactory extends com.nercms.schedule.sip.stack.sip.message.BaseMessageFactory {
	...
	public static Message createSubscribeRequest(SipProvider sip_provider,
		...
		//fym
		android.util.Log.v("UserAgent", recipient.toString() + ", "
								+ to.toString() + ", "
								+ from.toString() + ", "
								+ contact.toString());
		
		Message req = createRequest(sip_provider, SipMethods.NOTIFY,//SipMethods.SUBSCRIBE,
