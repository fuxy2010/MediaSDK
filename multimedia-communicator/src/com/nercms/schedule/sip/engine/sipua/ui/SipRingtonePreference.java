...
{   
    ...
    {
    	SP.set(mContext, SP.PREF_SIPRINGTONE, ringtoneUri != null ? ringtoneUri.toString() : SP.DEFAULT_SIPRINGTONE);
    }

    @Override
    protected Uri onRestoreRingtone() 
    {
    	String uriString = SP.get(mContext, SP.PREF_SIPRINGTONE, android.provider.Settings.System.DEFAULT_RINGTONE_URI.toString());
