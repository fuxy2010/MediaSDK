...
import com.nercms.schedule.sip.engine.net.impl.OSNetworkSystem;
import com.nercms.schedule.sip.engine.net.impl.PlainDatagramSocketImpl;
...
public class SipdroidSocket extends DatagramSocket
{
	...
	public void receive(DatagramPacket pack) throws IOException
	{
		...
		else
		{
			...
			super.receive(pack);
			android.util.Log.v("Baidu", "UR " + pack.getLength());
			//android.util.Log.v("Temp", "R " + (System.currentTimeMillis() - t));
		}
	}
